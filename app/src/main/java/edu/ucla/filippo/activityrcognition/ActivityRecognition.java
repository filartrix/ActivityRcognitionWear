package edu.ucla.filippo.activityrcognition;
...
import edu.ucla.filippo.activityrcognition.ActivityUtils.REQUEST_TYPE;
...
public class ActivityRecognition extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rect_activity_activity_recognition);
